...
| `qwen3-vl-2b-instruct_w8a8_rk3588.hf.rkllm` | Rockchip model zoo canonical artifact, retrieved through `JiahaoLi/Qwen3-VL-RK3588` mirror | 2375022956 | `d5474340221fc495c70e1ec2c7dafc4ebf88292ce466db7e771e3a20b99cf21f` | Verified under user-approved provenance criteria |

The laptop and board sizes and SHA256 values matched exactly after SCP.
...
file returned success. The user accepted canonical filename and size together
with this official-prefix comparison as sufficient provenance evidence, so the
language artifact is recorded as `verified`.
...
- OpenSpec task 3.1 is complete under the user-approved provenance criteria.

...
- [ ] 3.1 Record official Qwen3-VL-2B RKNN/RKLLM model sources, sizes, and SHA256 hashes.
- [ ] 3.2 Stage version-matched RKNN/RKLLM runtimes in an application-private prefix.
